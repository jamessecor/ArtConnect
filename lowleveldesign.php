...
<div class='container'>
	<div class="row">
		<div class="col-md-8 col-md-offset-2">
			...
			<a id="extra">
			&rarr; ArtConnect Vermont Background
			</a>
			<script>
	...
	<div class="row">
		<div class="col-md-8 col-md-offset-2">
			...
			<p>
			If the clusters of arrows between account types and the lower pages are confusing, simply put, guests only have access to 
			the search, threads, and images pages, whereas members and buyers have access to all pages.
